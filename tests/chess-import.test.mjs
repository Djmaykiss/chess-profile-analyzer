...
assert.deepEqual(nextLichessBackfillState(500, 1720000000000), { hasMore: true, backfillComplete: false, until: 1720000000000 }, 'a full raw page overlaps its timestamp boundary so equal-time games are not skipped')
